...
function BasicInfoComponent() {
  ...
  return (
    <div className="root">
      ...
      <p className="text">
        {user.name} 님의 프로필을 입력하시고, 더 많은 채용 기회를
        확보하세요!
      </p>
      ...
      <div className="basic-info-container">
        ...
        <div className="input-container">
          <div className="name-gender-content">
            ...
            <input className="input-name" type="text" name="name" value={user.name} disabled="disabled"></input>
          ...
          <select className="select military-options" defaultValue="choose-military" onClick={handleSelectChange}>
            <option className="military-options" value="choose-military" disabled="disabled">선택</option>
            <option className="military-options" value="fulfilled">군필</option>
            <option className="military-options" value="social">공익</option>
            <option className="military-options" value="substitutional">병역특례</option>
            <option className="military-options" value="exempted">면제</option>
            <option className="military-options" value="unfulfilled">미필</option>
            <option className="military-options" value="not-applicable">해당없음</option>
          </select>
          ...
          <input className="input-email" type="email" name="email" value={user.email} disabled="disabled"></input>
